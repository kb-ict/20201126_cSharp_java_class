...
public class CarAppMain {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 3; i++) {
			...
			new Customer(name[r.nextInt(5)], tel[r.nextInt(5)], address[r.nextInt(5)], new Car(model[r.nextInt(5)],
					year[r.nextInt(5)], color[r.nextInt(5)], company[r.nextInt(6)], price[r.nextInt(5)]))
							.printCustomerInfo();
		}
		...
		// 임베디드 애플리케이션 기계안에 들어가는 거
		// 지문체크 기계

//내풀이	System.out.println("\n-----------------------");
//		System.out.println("싱글톤 객체 생성");
//		System.out.println("-----------------------");
//		for (int i = 0; i < 3; i++) {
//			System.out.printf("%d번째 고객 ---------------- \n", (i + 1));
