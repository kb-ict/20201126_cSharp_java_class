...
namespace addressTest0218.control
{
    class AdressMenu
    {
        ...
        {
            Console.WriteLine("\n### 번호: " + (index + 1) + "\n-----------------------------");
            Console.WriteLine("아이디: " + addrList[index].Id);
            Console.WriteLine("이름: " + addrList[index].Name);
            Console.WriteLine("전화: " + addrList[index].Tel);
            Console.WriteLine("주소: " + addrList[index].Address);
            Console.WriteLine("이메일: " + addrList[index].Email);
            Console.WriteLine("-----------------------------");
        }
        ...
        static List<Student> editItem()
        {
            Console.WriteLine("-----------------------------");
            Console.WriteLine("    [메뉴] 5-2 주소록 수정");
            Console.WriteLine("-----------------------------");

            // ID, 이름 일치 시 해당 값 보여주고 수정
            Console.Write("ID값 입력\t: ");
            string id = Console.ReadLine();
            Console.Write("이름 입력\t: ");
            string name = Console.ReadLine();
            ...
            //Console.WriteLine("수정할 항목\t: ");
            //int menu = Convert.ToInt32(Console.ReadLine());

            //Console.WriteLine("수정할 이름 : ");
            Console.Write("1. 이름 : ");
            addrList[count[0]].Name = Console.ReadLine();

            Console.Write("2. 전화번호\t: ");
            addrList[count[0]].Tel = Console.ReadLine();

            Console.Write("3. 주소\t: ");
            addrList[count[0]].Address = Console.ReadLine();

            Console.Write("4. 이메일\t: ");
            addrList[count[0]].Email = Console.ReadLine();
            Console.WriteLine($"\n\n{count[0]}번째 항목 수정이 완료 되었습니다.");
            Console.WriteLine("-----------------------------");
