...
namespace VerySimpleExample
{
    public partial class Form1 : Form
    {
        ...
        {
            label_nowTime.Text = $"{DateTime.Now.Year}년 {DateTime.Now.Month}월 {DateTime.Now.Hour}시 {DateTime.Now.Minute}분 {DateTime.Now.Second}초";
        }
